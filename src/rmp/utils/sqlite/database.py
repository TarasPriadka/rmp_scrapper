...
class SqlConnector:
    ...
    def get(self, first: str, last: str) -> Tuple:
        ...
        return Teacher.parse_tuple(self.cursor.fetchall()[0])

    def get_all_profesors(self) -> List[Teacher]:
...
if __name__ == '__main__':
    ...
    sql = SqlConnector('/home/taras/Documents/data/rmp/db/teachers.db', 'deanza_big')
